...
final _mockPosts = <MediaPost>[
  MediaPost(
    ...
    authorUniqueId: 'SLP-J001',
    type: MediaType.photo,
    caption:
        '🔥 INCREÍBLE lo de Marco Silva hoy en la Copa Sub-19. Promedio de 8.8 validado por el colegiado. Los ojeadores del Madrid ya están tomando nota. #FuturoCrack #SportLinkPro',
    hashtags: ['#SportLinkPro', '#FútbolBase', '#Scouting'],
  ...
  MediaPost(
    ...
    authorUniqueId: 'SLP-S001',
    type: MediaType.reel,
    caption:
        'Lo que buscamos en un mediocentro moderno: visión periférica y primer toque. Luis Peña (SLP-1102) es un claro ejemplo de este perfil. 👀📋',
  ...
  MediaPost(
    ...
    authorUniqueId: 'SLP-B001',
    type: MediaType.photo,
    caption:
        'El talento no espera. Nueva colección Phantom Elite U19, disponible ahora en el Marketplace Oficial de SportLink. 👟⚡',
