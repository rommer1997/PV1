...
final List<_Intent> _knowledgeBase = [
  _Intent('sportcoins', ['sportcoin', 'moneda', 'dinero', 'pagar', 'sc', 'cobrar', 'ficha', 'kripto'], 
    'Las SportCoins (SC) son la moneda oficial del ecosistema SportLink. Se ganan únicamente compitiendo en torneos oficiales y NUNCA se pueden comprar con dinero real. Están blindadas en nuestro servidor inmutable.'),
  
  _Intent('escrow', ['escrow', 'bote', 'premio', 'intelijente', 'reparto', 'deposito', 'skrow', 'contrato'], 
    'El Smart Escrow es un bote blindado. Bloquea las SportCoins al iniciar un torneo y, una vez que el staff y el árbitro validan el resultado final, reparte automáticamente el premio al equipo ganador. Ni siquiera SportLink puede tocar esos fondos, garantizando zero corrupción.'),
  ...
  _Intent('qr', ['qr', 'pase', 'dijital', 'bip', 'entrar', 'puerta', 'estadio', 'q'], 
    '¡El Pase VIP! Es el código QR en la parte superior derecha o en tu Athletic CV. Sirve como tu acreditación. Al llegar al estadio de un torneo, el Staff lo escanea y el Escrow sabe automáticamente que ya te presentaste para jugar.'),
  
  _Intent('cv', ['cv', 'curriculum', 'carta', 'perfil', 'estadisticas', 'radar', 'fifa', 'ovr'], 
    'El Athletic CV es tú carta de vida deportiva. Reúne tus estadísticas, OVR dinámico validado por árbitros reales y tu gráfico de impacto (radar). Se actualiza autónomamente; ¡ningún jugador puede editar o inventarse sus propios números!'),
  
  _Intent('ia', ['ia', 'intelijencia', 'robot', 'bot', 'sportlink', 'quien', 'eres'], 
    'Soy Scout AI, la primera inteligencia deportiva 100% offline implantada en SportLink Pro. Conozco todos los protocolos de seguridad, desde el algoritmo del Smart Escrow hasta la salud mental de los jugadores.'),
  
  _Intent('saludo', ['hola', 'buenas', 'ey', 'que', 'tal', 'alluda', 'ola', 'hl'], 
    '¡Hola! Soy Scout AI, tu asistente experto en SportLink Pro. ¿Tienes dudas sobre cómo funcionan nuestros Árbitros, Tutores, el Smart Escrow o el Modo Crisis? ¡Pregunta lo que sea!'),
];
...
class SportLinkAIScreen extends ConsumerStatefulWidget {
  const SportLinkAIScreen({super.key});

  @override
  ConsumerState<SportLinkAIScreen> createState() => _SportLinkAIScreenState();
}

class _SportLinkAIScreenState extends ConsumerState<SportLinkAIScreen> {
  final TextEditingController _controller = TextEditingController();
  final ScrollController _scrollController = ScrollController();
  final List<_ChatMessage> _messages = [
    _ChatMessage(
      text: '¡Mister! Soy Scout AI 🧠, el cerebro hiper-rápido corriendo localmente en tu app. Conozco las reglas de SportLink al pie de la letra, hasta si tienes mala ortografía.\n\nPrueba preguntarme sobre tutores, árbitros o el modo crisis.', 
      isUser: false
    ),
  ];
