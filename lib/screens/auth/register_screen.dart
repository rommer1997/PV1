...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  String get _extraLabel {
    switch (_selectedRole) {
      case UserRole.scout:
        return 'Número de Licencia Scout (KYC)';
      case UserRole.referee:
        return 'ID de Árbitro Oficial';
      case UserRole.coach:
        return 'Club o Academia';
      case UserRole.journalist:
        return 'Medio de Comunicación';
      case UserRole.brand:
        return 'Nombre de la Empresa';
      case UserRole.tutor:
        return 'DNI / Documento del Tutor';
      case UserRole.player:
        return 'Posición (ej. Delantero)';
      case UserRole.fan:
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Selector de rol (si no viene preseleccionado)
                if (widget.role == null) ...[
                  Text(
                    'ROL',
                    style: TextStyle(
                ...
                _Field(
                  ...
                  ctrl: _extraCtrl,
                  isDark: isDark,
                  validator: _selectedRole == UserRole.fan
                      ? null
